...
from Desafios.Listas import numero
...
class ContaCorrente(Conta):
     def __init__(self, cliente, numero,  limite_valor=500, limite_saque=3):
       super().__init__(self, numero, cliente)
        self.limite_valor = limite_valor
        self.limite_saque = limite_saque

    #Metodo sacar tendo em conta o limite
    def sacar(self, valor):
        numero_saques = len([
